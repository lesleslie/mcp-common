...
- **Use UV for Tool Execution**
  ...
  - Execute tools like pyright, ruff, and mcp-common through UV: `uv run pyright`
...
- **Code Quality Validation**
  ...
  - Code should pass all quality checks when run through mcp-common
  - The ultimate goal is to run `python -m mcp-common -x -t` without any errors
...
- **Test Coverage Improvement (MANDATORY)**
  ...
  - **Target ≥90% coverage gate**: Matches `pyproject.toml --cov-fail-under=90.0` (and `.coverage-ratchet.json current_minimum: 90.0`). See [COVERAGE_POLICY.md](./docs/reference/COVERAGE_POLICY.md).
...
- **MCP Server Integration**
  ...
  - MCP tools: `execute_mcp-common`, `get_job_progress`, `get_comprehensive_status`
...
- **Quality Standards Maintenance**
  ...
  - Test all documentation updates by running `python -m mcp-common --comprehensive`
