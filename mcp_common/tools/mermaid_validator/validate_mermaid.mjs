...
//
// Designed for the mcp-common CI guard (test_mermaid_renders.py +
// `mcp-common docs check-mermaid`). Uses mermaid.parse() — the lexer-only
...
//
// The Python wrapper (mcp_common.tools.mermaid_validator.renderer) computes both
