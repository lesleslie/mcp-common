...
- mcp-common: Distinguish never-cycled feed from warming_up (HNSW hardening)
...
- mcp-common: Add Phase 1/4/12 module prerequisites (6 net-new modules + tests)

### Fixed

- mcp-common: Tolerate BaseExceptionGroup-wrapped cross-task teardown
- mcp-common: Tolerate cross-task aclose() in CommonMCPClient (REQ-001)

## [0.26.1] - 2026-09-14

### Fixed

- mcp-common: Declare httpx2 as runtime dep (closes 0.26.0 consumer import gap)
- mcp-common: Silence ty warnings on optional-dep lazy imports

## [0.26.0] - 2026-09-14

### Added

- mcp-common: Add HealthFeedState + aggregate_feed_states
- mcp-common: Extract CommonMCPClient SDK from akosha
...
- mcp-common: Use parenthesized except form for refurb compatibility
