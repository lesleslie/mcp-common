...
2. Add Oneiric-native settings wrapper and cache path helpers.
3. Implement the CLI factory with standard flags and snapshot-based status/health.
4. Update docs and examples to reflect Oneiric-only usage.
5. Roll out the CLI factory to MCP servers (session-buddy first, then
